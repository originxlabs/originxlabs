...
const StackcraftSection = () => {
  ...
  return (
    <section ref={sectionRef} id="stackcraft" className="py-28 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div className={`transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            <p className="text-sm uppercase tracking-[0.24em] text-muted-foreground mb-4">Learning + CMS Division</p>
            <div className="flex items-center gap-4 mb-5">
              <img src={stackcraftLogo} alt="StackCraft logo" className="h-11 w-auto rounded-md" />
              <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground">StackCraft</h2>
            </div>
